	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-6 my-3 jumbotron">
				...
				<form method="post" action="receptionist_next.php">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							...
							<input type="password" name="cpassword" class="form-control" id="confirm_password" placeholder="Confirm Password" autocomplete="off" onkeyup="check();" required>
							<span id="message"></span>
						</div>
					</div>
					<input type="submit" name="submit" value="Next Step" class="form-control btn-success" id="btn">
					<small>Already have an Acount ? <a href="receptionist_login.php">Login</a> Here </small>
				</form>
			</div>
			<div class="col-md-3"></div>
		</div>
