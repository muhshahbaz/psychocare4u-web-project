...
<body>
	...
	<div class="container-fluid">
		<div class="col-md-12">
			...
			if(isset($_GET['id']))
			{
				...
				$query="SELECT * FROM recept_detail WHERE username='$user'";
	...
	<section class="profile_container">
		<div class="profile_img_section">
			<img class="profile_img-LG" src="../receptionist/recept_img/<?php echo $row['pic'];?>" />	
		</div>
...
<a><i class="fas fa-graduation-cap text-info" style="font-size:27px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span style=" font-size:27px;"><?php echo $row['qualification'];?></span></a>
			
			<span style=" margin-top: 10px; font-size:24px;">
