...
<div class="container-fluid">
	<div class="col-md-12">
		...
		<?php
			...
			$sql="SELECT * FROM doct_detail WHERE status='pendding'";
			...
			if(mysqli_num_rows($result)>0)
			{
              ...
              <tbody>
                ...
                <tr>
	              ...
	              <td><a class="btn btn-info text-white" href="approve_ajax.php? id=<?php echo $row['username'];?>">Approve</a></td>
	             <td><a class="btn btn-danger text-white" href="reject_ajax.php? id=<?php echo $row['username'];?>">Reject</a></td>
