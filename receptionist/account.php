...
<option value="">Select Blood Group</option>
    ...
    <option value="Other">Other</option>
					...
					<p>Have a account? login <a href="patientlogin.php">Here</a></p>
				</form>	
			</div>
			<div class="col-md-3"></div>
		</div>
...
if(isset($_POST['create']))
{
	...
	if(count($error)==0)
	{
		$q="INSERT INTO patient (fname,lname,username,cnic,age,phone,gender,city,maritial_status,blood) VALUES ('$fname','$lname','$username','$cnic','$age','$phone','$gender','$city','$ms','$bg')";
