...
<body>
	...
	<?php include("../include/receptHeader.php");?>
	...
	if(isset($_POST['leave']))
	{
        ...
        $query="INSERT INTO tblleave (username,subject,reason,role,from_date,to_date) VALUES ('$username','$subject','$reason','receptionist','$from','$to')";
