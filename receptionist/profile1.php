...
<body>
	...
	$doct=@$_SESSION['recept'];

	$query="select * from recept_detail where username='$doct'";
							...
							<div class="col-md-6">
								...
								if(isset($_POST['update']))
								{
									...
									if(empty($profile))
									{
										...
										$query="update recept_detail set pic='$profile' where username='$doct'";
										$result=mysqli_query($conn,$query);
	...
	while($row=mysqli_fetch_array($result))
	{
		...
		$profile1=$row['pic'];
								...
								<form method="post" enctype="multipart/form-data">
									<img src="doc_img/<?php echo $profile1; ?>" style="height: 250px;" class="col-md-12">
									<br><br>
	...
	if(isset($_POST['up_password']))
	{
		...
		$query="SELECT password FROM recept_log WHERE username='$doct'";
		...
		{
			$q="UPDATE recept_log SET password='$new' WHERE username='$doct'"; 
