			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-2 my-4">
						<?php
						$date=date("Y-m-d");
						$q="SELECT * FROM appointment WHERE doct_username='$doct' AND app_date='$date' AND status='approved' AND mode='physical'";
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
									<?php
									@$mode="physical";
									$q="SELECT * FROM patient,appointment WHERE appointment.doct_username='$doct' AND appointment.status='approved' AND appointment.app_date='$date'AND appointment.mode='$mode' AND patient.username=appointment.pat_username";
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-10">
													Token:<input style="border-style: none;" type="text" name="u_id" size="4" value="<?php echo $row['pat_username'];?>" id="p_id" readonly><?php echo $row['fname'];?><br>
												...
												<div class="col-md-2">
													<a class="btn btn-info" href="data_ajax.php?id=<?php echo $row['id'];?>">Stack</a>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label>Diaseas</label>
													<input required type="text" name="diases" class="form-control">
												</div>
											</div>
											<div class="col-md-12">
												<div class="row">
														...
														<div class="form-group">
                                                             <label>Medicines Name</label>
                                                              <div class="input-group">
                                                                 <input required type="text" id="search_data" placeholder="" autocomplete="off" class="form-control" name="medi" />
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<textarea required name="remark" class="form-control" cols="7" rows="6"></textarea>
														</div>
													</div>
												</div>
											</div>
