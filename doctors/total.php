    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10" >
                ...
                <h3 style="color: #2BDCEE" class="titulo-tabla">Total Patients Record</h3>

                <?php

                $q="SELECT * FROM appointment,patient WHERE appointment.pat_username=patient.username AND appointment.doct_username='$doct' AND appointment.status='checked'";
