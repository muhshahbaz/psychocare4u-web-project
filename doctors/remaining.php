    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10" >
                ...
                $q="SELECT * FROM appointment,patient WHERE appointment.pat_username=patient.username AND appointment.doct_username='$doct' AND appointment.status='approved' AND app_date='$date'";
